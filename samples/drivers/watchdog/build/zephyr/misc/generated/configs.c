...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_MCUX_WWDT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_MCUX_WWDT_WARNING_INTERRUPT_CFG, 0);
